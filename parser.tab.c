...
{
       0,   103,   103,   104,   105,   107,   108,   109,   111,   116,
     122,   127,   132,   137,   144,   149,   155,   161,   167,   173
};
#endif
...
static const char *const yytname[] =
{
  ...
  "ID", "PRINT", "$accept", "program", "commands", "command", "definition",
  "print", "assignment", YY_NULLPTR
};
#endif
...
{
       5,    17,    18,    19,    20,    21,     1,     4,    14,     6,
       7,     8,    22,    23,    24,    25,    26,    16,    13,     0,
      15
};

static const yytype_int8 yycheck[] =
{
       4,     7,     8,     9,    10,    11,     3,     0,     6,    13,
      14,    15,     7,     8,     9,    10,    11,     5,    14,    -1,
      14
};
...
{
       0,     3,    17,    18,     0,     4,    13,    14,    15,    19,
      20,    21,    22,    14,     6,    14,     5,     7,     8,     9,
      10,    11,     7,     8,     9,    10,    11
};
...
#line 111 "parser.y" /* yacc.c:1646  */
    {
		if(check_redeclaration((yyvsp[0]))){
			null_values.emplace((yyvsp[0]));
		}
	}
...
#line 116 "parser.y" /* yacc.c:1646  */
    {	
		if(check_redeclaration((yyvsp[-2]))){
			int val = stoi((yyvsp[0]));
			int_values.emplace((yyvsp[-2]), val);
		}
	}
...
#line 122 "parser.y" /* yacc.c:1646  */
    {
		if(check_redeclaration((yyvsp[-2]))){
			str_values.emplace((yyvsp[-2]), (yyvsp[0]));
		}
	}
...
#line 127 "parser.y" /* yacc.c:1646  */
    {
		if(check_redeclaration((yyvsp[-2]))){
			bool_values.emplace((yyvsp[-2]), true);
		}
	}
...
#line 132 "parser.y" /* yacc.c:1646  */
    {
		if(check_redeclaration((yyvsp[-2]))){
			bool_values.emplace((yyvsp[-2]), false);
		}
	}
...
#line 137 "parser.y" /* yacc.c:1646  */
    {
		if(check_redeclaration((yyvsp[-2]))){
			float_values.emplace((yyvsp[-2]), stod((yyvsp[0])));
		}
	}
...
#line 149 "parser.y" /* yacc.c:1646  */
    {
		if(check_declaration((yyvsp[-2]))){
			free_name((yyvsp[-2]));
			int_values.emplace((yyvsp[-2]), stoi((yyvsp[0])));
		}
	}
